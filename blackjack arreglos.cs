...
namespace blackjack_arreglos2
{
    class Program
    {
        static void Main(string[] args)
        {
            int carta = 0, carta2 = 0, jugadores = 0, turnos = 0, max = 0, empate = 0, nadieGana = 0, eLMasCercanoA21 = 0;
            ...
            for (int i = 0; i < jugadores-1; i++) //organizar los datos de menor a mayor se hace el proceso tanto veces como jugadores halla
            {
